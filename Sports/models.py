...
class Sport(models.Model):
    ...
    image           = models.ImageField(null = True, upload_to = 'sports_pics')
...
def pre_save_post_receiver(sender, instance, *args, **kwargs):
    ...
    exist       = Sport.objects.filter(slug = slug).exists()
    if exist:
...
pre_save.connect(pre_save_post_receiver, sender = Sport)